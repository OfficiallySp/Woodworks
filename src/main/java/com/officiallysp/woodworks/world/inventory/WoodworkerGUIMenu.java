...
package com.officiallysp.woodworks.world.inventory;
...
public class WoodworkerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WoodworkerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WoodworksModMenus.WOODWORKER_GUI.get(), id);
