 ...
 *
 */
package com.officiallysp.woodworks;
...
import com.officiallysp.woodworks.init.WoodworksModTabs;
...
public class WoodworksMod {
	public static final Logger LOGGER = LogManager.getLogger(WoodworksMod.class);
	public static final String MODID = "woodworks";
	...
	public WoodworksMod() {
		...
		WoodworksModMenus.REGISTRY.register(bus);
	}
